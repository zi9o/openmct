...
define(
    function () {
        ...
        /**
         * Policy preventing the Fixed position view from being made
         * available for domain objects which have non-numeric telemetry.
         * @implements {Policy.<View, DomainObject>}
         * @constructor
         * @memberof platform/features/plot
         */
        function FixedViewPolicy() {
        }
        ...
        FixedViewPolicy.prototype.allow = function (view, domainObject) {
            if (view.key === 'plot') {
